...
class _ChatState extends State<Chat> {
  final database = FirebaseDatabase.instance.reference().child("chats").child(patientModel.id+"p");
                ...
                itemBuilder: (BuildContext context, DataSnapshot snapshot,
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SingleChat(snapshot.value['name'].toString() ,snapshot.value["image"] , snapshot.value["id"])));
                    },
                    child: Card(
                      child: ListTile(
                        leading: SizedBox(
